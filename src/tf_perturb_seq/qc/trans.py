...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Key in mdata.uns for trans results (default: 'trans_per_guide_results')."
    )
    parser.add_argument(
        "--log2fc-col", default="log2_fc",
        help="Column name for log2 fold change (default: 'log2_fc')."
    )
    parser.add_argument(
        "--pvalue-col", default="p_value",
        help="Column name for p-value (default: 'p_value')."
    )
    parser.add_argument(
