...
Deeper status: [`crispr_pipeline/README.md`](crispr_pipeline/README.md), [`cnmf/README.md`](cnmf/README.md). Open issue: [HTv2 cNMF testbed verification](../../issues/htv2-cnmf-testbed.md).
...
- HTv2 doesn't get the same canonical-reference treatment as the production datasets: schemas in [`schemas/`](../../schemas/) deliberately stay scoped to production. See [`issues/README.md`](../../issues/README.md) for the rationale.
