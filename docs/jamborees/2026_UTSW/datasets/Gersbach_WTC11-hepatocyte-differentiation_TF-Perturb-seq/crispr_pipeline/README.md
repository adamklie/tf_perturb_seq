...
See [Issue: Gersbach Hep deliverables](../../../issues/gersbach-hep-deliverables.md) for the full ask + reference example (Huangfu DE [`syn74834952`](https://www.synapse.org/Synapse:syn74834952) is the layout target).
