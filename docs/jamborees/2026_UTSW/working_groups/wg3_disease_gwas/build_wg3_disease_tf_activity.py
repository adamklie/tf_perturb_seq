...
Output: `working_groups/wg3_disease_gwas/disease_tf_activity.tsv` — one row per
TF flagged as disease-relevant (per HPO MONDO + OMIM associations), with
...
per-dataset ED bundles land.

Usage:
    python scripts/build_wg3_disease_tf_activity.py
"""
...
OUTPUT = JAMB / "working_groups/wg3_disease_gwas/disease_tf_activity.tsv"
