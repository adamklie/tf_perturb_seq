...
| [`wg4_grn_inference/network_structure_by_lineage.tsv`](wg4_grn_inference/network_structure_by_lineage.tsv) | 🟡 (2/3 lineages — Hon CM CRISPR bundle blocked) | DE has 3.4× ESC's edge count; jaccard edge overlap = 0.029 (massive rewiring) | `pd.read_csv(p, sep="\t")` |
