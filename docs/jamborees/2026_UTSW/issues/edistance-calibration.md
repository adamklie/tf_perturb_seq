...
| Run | Targets | Cells/target (median) | Targeting `distance_mean` median | NC `distance_mean` median | NC vs targeting ratio | NC count with `pval_mean=0` |
|---|---:|---:|---:|---:|---:|---:|
| HTv2 reference | 64 | 2000 | **1.78** | _no NCs in run_ | — | _n/a_ |
| Huangfu DE | 2267 | 2000 | **93.21** | 91.70 | **1.02×** | **100 / 100** |
| Huangfu ESC | 2267 | 2000 | **527.33** | 528.25 | **1.00×** | **100 / 100** |
