...
from the canonical pipeline config file for each dataset.
...
DATASETS: list[dict] = [
    {
        ...
        "canonical_config": "Hon_WTC11-cardiomyocyte-differentiation_TF-Perturb-seq_initial_run.config",
        "canonical_run_label": "initial_run",
    ...
    },
    {
        ...
        "canonical_config": "Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq_muddy_penguin.config",
        "canonical_run_label": "muddy_penguin",
    ...
    },
    {
        ...
        "multiplexing_method": "none",
        "n_measurement_sets": 8,
        "canonical_config": "Huangfu_HUES8-embryonic-stemcell-differentiation_TF-Perturb-seq_2026_04_13.config",
        "canonical_run_label": "sceptre_v1",
    ...
    },
    {
        ...
        "canonical_config": "nextflow.config",
        "canonical_run_label": "?",
        "gcs_output_path": "?",
...
def main() -> None:
    ...
    for entry in DATASETS:
        cfg_name = entry.get("canonical_config")
