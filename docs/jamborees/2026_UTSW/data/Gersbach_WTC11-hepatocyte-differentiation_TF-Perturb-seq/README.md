...
Deeper status: [`crispr_pipeline/README.md`](crispr_pipeline/README.md), [`energy_distance/README.md`](energy_distance/README.md). Open issue: [Gersbach Hep deliverables](https://github.com/adamklie/tf_perturb_seq/issues/gersbach-hep-deliverables.md).
