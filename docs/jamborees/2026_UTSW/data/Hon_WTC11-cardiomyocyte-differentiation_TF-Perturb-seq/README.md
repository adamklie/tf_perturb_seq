...
Open: [Hon CM CRISPR pipeline gap](https://github.com/adamklie/tf_perturb_seq/issues/hon-cm-crispr-bundle.md), [Hon CM cNMF Stage 1](https://github.com/adamklie/tf_perturb_seq/issues/20).
