...
**Status**: ✅ Complete on Synapse [`syn74893844`](https://www.synapse.org/Synapse:syn74893844) — `042926_huangfu_de_torchcnmf_KskillA`. Selected k = 200, density threshold = 2.0.
...
| Mirror command | `nohup .venv/bin/python docs/jamborees/2026_UTSW/data/mirror_cnmf_outputs.py --dataset Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq --source-dir /cellar/.../042926_huangfu_de_torchcnmf_KskillA --selected-k 200 &` |
...
A new Hon-mirroring SLURM script (`050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch.sh`) is also pre-staged on HPC if we ever want to re-run with Hon's exact params. **Holding submission** since the 042926 run is sufficient. See [Issue 5](https://github.com/adamklie/tf_perturb_seq/issues/htv2-cnmf-testbed.md).
