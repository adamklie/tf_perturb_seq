...
Implements the curation rule documented in `schemas/cnmf.json` -> `inclusion_rule`:
  ...
  (1) Selected-k full data for downstream analysis (WG1 + WG2):
        ...
        - full Eval/<sel>_<dt>/ TXT outputs
  ...
  (2) Sweep-as-provenance (revisit-the-k-decision):
        ...
        - Eval/<k>_<dt>/ for every (k, dt) (full TXT outputs)
...
Usage:
    python mirror_cnmf_outputs.py \\
        ...
        --source-dir <your-hpc-scratch>/PerturbNMF/Result/050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch \\
        --selected-k 50
...
def main() -> int:
    ...
    ap.add_argument("--density-threshold", type=float, default=2.0, help="Density threshold for the selected-k outputs (default: 2.0)")
