...
Acceptance criteria + the production-launch plan are in [Issue 5: HTv2 cNMF testbed verification → production launch](https://github.com/adamklie/tf_perturb_seq/issues/htv2-cnmf-testbed.md).
