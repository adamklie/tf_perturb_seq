...
## Calibration sanity (relevant to [Issue 1](https://github.com/adamklie/tf_perturb_seq/issues/edistance-calibration.md))
...
- **Testbed**, not a production dataset. Useful as a self-contained energy-distance reference at small scale to compare against the production Huangfu DE/ESC runs (which had calibration concerns; see [Issue 1](https://github.com/adamklie/tf_perturb_seq/issues/edistance-calibration.md)).
