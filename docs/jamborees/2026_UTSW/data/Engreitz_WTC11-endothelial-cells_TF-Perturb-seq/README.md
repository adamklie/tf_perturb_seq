...
Open issue: [Engreitz endothelial data not on portal](https://github.com/adamklie/tf_perturb_seq/issues/engreitz-no-data.md).

## Source data

None yet. Once the Engreitz team uploads to the IGVF portal under the `TF Perturb-seq Project` collection, the [`data/query_igvf_portal.py`](../../data/query_igvf_portal.py) snapshot will pick it up and the rest of the pipeline can begin.
