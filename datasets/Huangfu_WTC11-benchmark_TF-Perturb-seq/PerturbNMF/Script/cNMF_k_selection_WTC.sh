...
#SBATCH --job-name=030726_k_sel_WTC_Huangfu
#SBATCH --output=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Huangfu_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Plot/k_selection_WTC/logs/%j.out
#SBATCH --error=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Huangfu_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Plot/k_selection_WTC/logs/%j.err
...
mkdir -p "$RUN_DIR/Plot/k_selection_WTC/logs"
...
python3 /oak/stanford/groups/engreitz/Users/ymo/Tools/PerturbNMF/src/Stage3_Interpretation/A_Plotting/Slurm_Version/cNMF_k_selection.py \
        ...
        --run_name "$RUN_NAME" \
        --save_folder_name "$RUN_DIR/Plot/k_selection_WTC" \
