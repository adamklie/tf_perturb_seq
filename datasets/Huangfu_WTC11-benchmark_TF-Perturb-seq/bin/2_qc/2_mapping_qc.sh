#!/bin/bash
#SBATCH --job-name=Huangfu_WTC11-benchmark_TF-Perturb-seq_mapping_qc
...
#SBATCH --output=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Huangfu_WTC11-benchmark_TF-Perturb-seq/bin/2_qc/%x.%A.out
...
# Dataset name
SAMPLE="Huangfu_WTC11-benchmark_TF-Perturb-seq"

# Input MuData from CRISPR pipeline
H5MU="/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Huangfu_WTC11-benchmark_TF-Perturb-seq/results/1_CRISPR_pipeline/2025_11_26/inference_mudata.h5mu"

# Output directory
OUT="/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Huangfu_WTC11-benchmark_TF-Perturb-seq/results/2_qc/2025_12_01"
