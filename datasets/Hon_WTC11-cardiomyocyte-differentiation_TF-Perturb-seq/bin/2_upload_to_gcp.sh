...
#
# NOTE: There are existing fastqs at gs://igvf-pertub-seq-pipeline-data/WTC11_CM_TF_PerturbSeq/
# from a prior upload. Check with Ian/Hon lab whether these are current before re-uploading.
#
# Usage:
...
OUTPUT_FILE=${DATASET_DIR}/samplesheets/sample_metadata_gcp_$(date +%Y_%m_%d).csv
