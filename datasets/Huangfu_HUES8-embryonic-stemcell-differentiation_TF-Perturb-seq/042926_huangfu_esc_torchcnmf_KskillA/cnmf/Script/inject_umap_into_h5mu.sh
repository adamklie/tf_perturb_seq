#!/bin/bash
#SBATCH --job-name=huangfu_esc_inject_umap_K200
...
H5MU="/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-embryonic-stemcell-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_esc_torchcnmf_KskillA/Inference/adata/cNMF_200_2_0.h5mu"

python -u "/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-embryonic-stemcell-differentiation_TF-Perturb-seq/PerturbNMF/Script/inject_umap_into_h5mu.py" \
    --h5mu_path "$H5MU" \
    --prog_key cNMF \
    --n_comps_pca 50 \
    --n_neighbors 30 \
