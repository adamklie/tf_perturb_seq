#!/bin/bash
#SBATCH --job-name=042926_huangfu_esc_torchcnmf_KskillA
...
set -euo pipefail
mkdir -p "/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-embryonic-stemcell-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_esc_torchcnmf_KskillA/Inference/logs"
