#!/bin/bash
#SBATCH --job-name=huangfu_de_excel_K200
...
#SBATCH --mem=128G
#SBATCH --output=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_de_torchcnmf_KskillA/Interpretation/Summary_table/logs/%j.out
#SBATCH --error=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_de_torchcnmf_KskillA/Interpretation/Summary_table/logs/%j.err
...
python -u /cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Script/cNMF_compile_excel_summary.py \
    --out_dir "$OUT_DIR" \
    --run_name "$RUN_NAME" \
    --save_path "$SAVE_PATH" \
    --K 200 \
