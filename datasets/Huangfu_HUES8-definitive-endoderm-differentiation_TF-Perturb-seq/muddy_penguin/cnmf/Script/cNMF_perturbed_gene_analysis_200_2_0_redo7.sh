#!/bin/bash
#SBATCH --job-name=huangfu_de_perturbgene_redo7
...
#SBATCH --mem=128G
#SBATCH --output=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_de_torchcnmf_KskillA/Plot/Perturb_gene_200_2_0/logs/%j.out
#SBATCH --error=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/042926_huangfu_de_torchcnmf_KskillA/Plot/Perturb_gene_200_2_0/logs/%j.err
...
python -u /cellar/users/aklie/projects/tf_perturb_seq/external/PerturbNMF/src/Stage3_Interpretation/A_Plotting/Slurm_Version/cNMF_perturbed_gene_analysis.py \
    ...
    --gene_list_file "/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Script/empty_genes_to_redo.txt" \
    --top_n_programs 10 \
