#!/bin/bash
# Production cNMF launch for Huangfu HUES8 Definitive Endoderm.
...
#SBATCH --job-name=050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch
#SBATCH --output=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch/logs/%j.out
#SBATCH --error=/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Result/050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch/logs/%j.err
...
RUN_NAME="050926_HuangfuDE_20iter_5KHVG_torch_halsvar_batch"
LOG_DIR="$OUT_DIR/$RUN_NAME"
DATA_H5AD="/cellar/users/aklie/projects/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/PerturbNMF/Data/DE_muddy_penguin_perturbnmf.h5ad"
