...
#SBATCH --gpus=1
#SBATCH --output=/cellar/users/aklie/data/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/bin/slurm_logs/%x.%A.out
...
# Input file
input_h5=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/Cell_Ranger_Output/filtered_feature_bc_matrix.h5
scripts_dir=/cellar/users/aklie/data/datasets/tf_perturb_seq/scripts
output_dir=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Huangfu_HUES8-definitive-endoderm-differentiation_TF-Perturb-seq/Transcriptome_Analysis
