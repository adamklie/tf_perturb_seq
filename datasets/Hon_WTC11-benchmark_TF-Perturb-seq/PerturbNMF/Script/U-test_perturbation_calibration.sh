...
#SBATCH --output=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Evaluation/Calibration/logs/%j.out      # Output file (%j = job ID)
#SBATCH --error=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Evaluation/Calibration/logs/%j.err       # Error file
