...
#SBATCH --job-name=030726_k_sel_2_0_Hon
#SBATCH --output=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Plot/k_selection_2_0/logs/%j.out
#SBATCH --error=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/Plot/k_selection_2_0/logs/%j.err
...
python3 /oak/stanford/groups/engreitz/Users/ymo/Tools/PerturbNMF/src/Stage3_Interpretation/A_Plotting/Slurm_Version/cNMF_k_selection.py \
        ...
        --sel_threshs 2.0 \
        --samples IGVFDS6244NAXC IGVFDS8721BKRO IGVFDS9332KWPJ IGVFDS9613DDRB
