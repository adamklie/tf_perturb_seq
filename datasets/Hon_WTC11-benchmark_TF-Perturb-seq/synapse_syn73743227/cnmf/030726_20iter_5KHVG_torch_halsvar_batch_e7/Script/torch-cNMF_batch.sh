...
#SBATCH --output=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/logs/%j.out      # Output file (%j = job ID)
#SBATCH --error=/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Result/030726_20iter_5KHVG_torch_halsvar_batch_e7/logs/%j.err       # Error file
...
python3 /oak/stanford/groups/engreitz/Users/ymo/Tools/cNMF_benchmarking/cNMF_benchmarking_pipeline/Inference/torch-cNMF/Slurm_Version/torch-cNMF_inference_pipeline.py\
        --counts_fn "/oak/stanford/groups/engreitz/Users/ymo/Project/IGVF_Hon_WTC11/Data/inference_mudata_cleaned.h5ad" \
