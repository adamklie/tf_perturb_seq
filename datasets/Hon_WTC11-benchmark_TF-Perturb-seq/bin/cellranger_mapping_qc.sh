#!/bin/bash
#SBATCH --job-name=Hon_WTC11-benchmark_TF-Perturb-seq_CellRanger_mapping_qc
#SBATCH --partition=carter-gpu
#SBATCH --account=carter-gpu
#SBATCH --gpus=1
#SBATCH --output=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Hon_WTC11-benchmark_TF-Perturb-seq/bin/slurm_logs/%x.%A.out
...
# Input file
input_h5=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Hon_WTC11-benchmark_TF-Perturb-seq/results/2_qc/2025_12_02/filtered_feature_bc_matrix.h5
scripts_dir=/cellar/users/aklie/data/datasets/tf_perturb_seq/scripts/CellRanger_qc
output_dir=/cellar/users/aklie/data/datasets/tf_perturb_seq/datasets/Hon_WTC11-benchmark_TF-Perturb-seq/results/2_qc/2025_12_02/CellRanger_qc
