...
for s in "${SCRIPT_GENE}" "${SCRIPT_GUIDE}" "${SCRIPT_INTENDED}"; do
...
run_cmd mkdir -p "${DIR_GENE}" "${DIR_GUIDE}" "${DIR_INTENDED}"

###############################################
# Step 1: gene mapping QC
###############################################
echo "[1/3] Gene mapping QC"
