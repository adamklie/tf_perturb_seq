...
and writes the result to `working_groups/wg1_data_qc/qc_summary.tsv`.

Re-run whenever a new dataset gets a canonical CRISPR pipeline mirror on
...
Usage:
    python scripts/build_wg1_qc_summary.py
"""
