...
#SBATCH -t 06:00:00
#SBATCH -o /cellar/users/aklie/projects/tf_perturb_seq/scratch/qc_array_logs/qc_array.%A_%a.out
#SBATCH -e /cellar/users/aklie/projects/tf_perturb_seq/scratch/qc_array_logs/qc_array.%A_%a.err
