...
Output: `working_groups/wg3_disease_gwas/examples/tf_convergence_scorecard.tsv`

Usage:
    python working_groups/wg3_disease_gwas/examples/build_wg3_tf_convergence_scorecard.py
"""
...
SOURCE = JAMB / "working_groups/wg3_disease_gwas/examples/disease_tf_activity.tsv"
OUTPUT = JAMB / "working_groups/wg3_disease_gwas/examples/tf_convergence_scorecard.tsv"
