...
Run from the jamboree root:
    ...
    uv run python working_groups/wg4_grn_inference/examples/examples.py
"""
...
def load_network_structure_by_lineage():
    return pd.read_csv(
        JAMBOREE_ROOT / "working_groups/wg4_grn_inference/examples/network_structure_by_lineage.tsv",
        sep="\t",
    )
