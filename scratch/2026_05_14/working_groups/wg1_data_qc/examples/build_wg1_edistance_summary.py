...
(see caveat), and a calibration_state classification.
...
Re-run whenever a new dataset's ED output lands.

Usage:
    python working_groups/wg1_data_qc/examples/build_wg1_edistance_summary.py
"""
...
OUTPUT = JAMB / "working_groups/wg1_data_qc/examples/edistance_summary.tsv"
